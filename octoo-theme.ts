...
export const octooTheme: CustomThemeConfig = {
    name: 'octoo-theme',
    properties: {
		// =~= Theme Properties =~=
		...
		// =~= Theme Colors  =~=
		// primary | #0FBA81 
		"--color-primary-50": "255 251 243", // #fffbf3
		"--color-primary-100": "255 250 239", // #fffaef
		"--color-primary-200": "255 249 235", // #fff9eb
		"--color-primary-300": "255 245 222", // #fff5de
		"--color-primary-400": "255 237 198", // #ffedc6
		"--color-primary-500": "255 229 173", // #ffe5ad
		"--color-primary-600": "230 206 156", // #e6ce9c
		"--color-primary-700": "191 172 130", // #bfac82
		"--color-primary-800": "153 137 104", // #998968
		"--color-primary-900": "125 112 85", // #7d7055
		// secondary | #4F46E5 
